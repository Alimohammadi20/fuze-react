...
function NotificationPanel(props) {
  ...
  useEffect(() => {
    ...
    setTimeout(
      () =>
        createNotification({
          message: 'آفریییین، صدباریکلا بهت ..!',
    ...
    setTimeout(
      () =>
        createNotification({ message: 'یه مشکلی پیش اومده!', options: { variant: 'error' } }),
      6000
    );
    ...
    setTimeout(
      () =>
        createNotification({
          message: 'یه مشکلی تو سایت رخ داده',
    ...
    setTimeout(
      () =>
        createNotification({
          message: 'یه پیام بعنوان اطلاعیه',
        ...
        <FuseScrollbars className="p-16">
          <div className="flex flex-col">
            <div className="flex justify-between items-end pt-136 mb-36">
              <Typography className="text-28 font-semibold leading-none">اطلاعیه ها</Typography>
              <Typography
